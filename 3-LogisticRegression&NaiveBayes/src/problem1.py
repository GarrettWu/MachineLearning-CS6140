...
def k_fold_validation(dataset, learningrate, tolerance, folds=10):
    ...
    for k in range(folds):
        ...
        costs.append(cost_function(X_train, y_train, w))
...
def test_spambase():
    ...
    k_fold_validation(dataset, 0.1e-3, 1) 
...
def test_breastcancer():
    ...
    k_fold_validation(dataset, 0.1e-3, 0.3e-1)
...
def test_diabetes():
    ...
    k_fold_validation(dataset, 0.3e-4, 0.1e-1)
    print()
